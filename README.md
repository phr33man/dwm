...
Okay, okay, actually I keep a readme in `bs.mom` for my whole system, including the binds here.
...
- [Clickable statusbar](https://dwm.suckless.org/patches/statuscmd/) with my build of [dwmblocks](https://github.com/phr33man/dwmblocks).
...
```bash
git clone https://github.com/phr33man/dwm
cd dwm
sudo make install
```
